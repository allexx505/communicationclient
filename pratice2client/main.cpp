...
void main()
{
	...
	serveraddr.sin_port = htons(4601);			//定义链接端口
	serveraddr.sin_addr.S_un.S_addr = inet_addr("127.0.0.1");//定义链接的IP地址，本机地址

	HANDLE mhandle;
	DWORD nthreadid = 0;
	char headmessage[] = "from client01:  ";
	char buffer[1024];
